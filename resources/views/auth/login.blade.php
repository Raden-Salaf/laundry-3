<x-layout-guest :title="'Login - Sistem Informasi Laundry'">
    ...
    <div class="d-flex align-items-center justify-content-center min-vh-100 p-4" style="background: linear-gradient(135deg, #f4f8fc 0%, #e1e9f5 100%);">
        
        <div class="w-100" style="max-width: 400px;">
            
            {{-- Brand Mark --}}
            <div class="text-center mb-4">
                <div class="d-inline-flex align-items-center justify-content-center bg-white shadow-sm rounded-4 p-3 mb-3" style="width: 70px; height: 70px;">
                    <span class="fs-2">🫧</span>
                </div>
                <h3 class="fw-bold text-dark mb-1">Fresh Laundry</h3>
