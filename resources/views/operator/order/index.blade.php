<x-layout-app :title="'Transaksi Laundry'">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('operator.order.create') }}" class="btn btn-primary px-4 py-2 rounded-3 d-flex align-items-center gap-2">
                    ...
                    @forelse ($orders as $order)
                        <tr>
                            ...
                            <td class="px-4 py-3 text-end">
                                <a href="{{ route('operator.order.show', $order->id) }}" class="btn btn-sm btn-outline-primary px-3 rounded-2">
                                    Detail
                                </a>
                            </td>
                        </tr>
